...
:asciidoctor-source: https://raw.githubusercontent.com/hemanik/arquillian-extension-persistence/documentation/docs
:numbered:
:sectlink:
:sectanchors:
:sectid:
...
*Arquillian Persistence Extension* was created to help you writing tests
where persistence layer is involved. Inspired by great framework called
http://unitils.org/[Unitils], it brings bunch of annotations to help you
...
include::{asciidoctor-source}/persistence-overview.adoc[]
