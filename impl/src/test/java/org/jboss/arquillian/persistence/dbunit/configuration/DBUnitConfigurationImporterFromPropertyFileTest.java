...
public class DBUnitConfigurationImporterFromPropertyFileTest
{

   @Test
   public void should_extract_batched_statement_flag_from_external_property_file() throws Exception
   {
      DBUnitConfiguration dbunitConfiguration = loadFromPropertyFile();
   ...
   private DBUnitConfiguration loadFromPropertyFile() throws IOException
   {
      // given
      ...
      // when
      Configuration.importTo(dbunitConfiguration).loadFrom(properties);
