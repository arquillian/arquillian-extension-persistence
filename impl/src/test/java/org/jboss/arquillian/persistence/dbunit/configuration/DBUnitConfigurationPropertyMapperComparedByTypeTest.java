...
public class DBUnitConfigurationPropertyMapperComparedByTypeTest
{
   ...
   {
      return $(
               $("http://www.dbunit.org/properties/datatypeFactory", HsqldbDataTypeFactory.class),
               $("http://www.dbunit.org/properties/statementFactory", StatementFactory.class),
               $("http://www.dbunit.org/properties/resultSetTableFactory", ForwardOnlyResultSetTableFactory.class),
               $("http://www.dbunit.org/properties/primaryKeyFilter", DefaultColumnFilter.class),
               $("http://www.dbunit.org/properties/mssql/identityColumnFilter", DefaultColumnFilter.class),
               $("http://www.dbunit.org/properties/metadataHandler", NetezzaMetadataHandler.class)
            );
   }
}
